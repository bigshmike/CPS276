...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mbrown99';//this will be your WCC username
      $dbUsr = 'mbrown99';//this will be your WCC username
      $dbPass = '5vWuxU6beu4y';//this will be the password found in the video.
